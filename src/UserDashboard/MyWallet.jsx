    ...
    return (
        <div className="w-full max-w-5xl mx-auto bg-white border border-[#E5E7EB] rounded-md p-5 md:p-8">
            ...
            <div className="mt-6 flex flex-col items-center text-center">
                ...
                <span className="bg-[#F46A2A] text-white text-sm px-3 py-1 rounded-md font-semibold mt-3">Ð0</span>
                <p className="mt-5 text-gray-600 max-w-xl">
                    Your wallet amount is automatically deducted from your next booking charges.
                </p>
                <p className="mt-4 text-gray-600">
                    Have a gift card? Redeem it{" "}
                    <button className="text-[#01788E] font-medium underline-offset-2 hover:underline">here</button>.
                </p>
                ...
                <div className="mt-8 flex items-center justify-center">
                    <div className="bg-[#E7EAEE] rounded-full flex p-1 w-64 justify-between">
                        {["active", "used"].map((tab) => (
                            <button
                                key={tab}
                                className={`w-1/2 py-2 rounded-full font-medium transition text-sm ${
                                    activeTab === tab ? "bg-white shadow-sm text-[#5D4F52]" : "text-[#5D4F52]"
                                }`}
                ...
                <div className="mt-6 text-[#01788E] font-semibold text-lg">Ð0</div>
