...
export default function Summary({
    itemSummary, showInput, setShowInput,
    address, date, time, serviceTitle,
    liveAddress, open, setOpen
}) {
    ...
    const displayAddress = liveAddress?.displayAddress || address || "";
            ...
            <div>
                ...
                <div className="space-y-2">
                    {itemSummary.map((item, index) => (
                        <div key={item.id ?? index} className="bg-gray-50 rounded-lg p-3 border border-gray-200 hover:bg-gray-100 transition-colors">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        ...
                        {time && (
                            <div className="bg-gray-50 rounded-lg p-2 border border-gray-200">
                                ...
                                <p className="font-medium text-gray-800 text-sm">{time}</p>
                            </div>
                        )}
                    </div>
                </div>
            ...
            {displayAddress && (
                <div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                        <p className="text-sm text-gray-800 leading-relaxed">{displayAddress}</p>
                    </div>
                </div>
            )}
            ...
            <div>
                ...
                {!showInput ? (
                    <button
                        ...
                        className="w-full py-2 border border-dashed border-gray-300 rounded-lg text-sm text-gray-600 hover:border-[#01788E] hover:text-[#01788E] transition-colors"
        ...
        <>
                    ...
                    <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                        <div className="p-4 border-b border-gray-200">
                            ...
                            <p className="text-xs text-gray-500 mt-0.5">
                                {itemSummary.length} item{itemSummary.length !== 1 ? 's' : ''}
                            </p>
                        </div>
                        <div
                            ref={scrollContainerRef}
                            className="overflow-y-auto p-4"
                            style={{ maxHeight: 'calc(100vh - 180px)', minHeight: '200px', scrollbarWidth: 'thin', scrollbarColor: '#CBD5E0 #F7FAFC' }}
                        >
                            <SummaryContent promoRef={promoInputRefDesktop} />
                        </div>
                    </div>
                </div>
            </div>
            ...
            {open && (
                <>
                    ...
                    {/* Bottom Sheet */}
                    <div
                        className="lg:hidden fixed bottom-0 left-0 w-full bg-white z-60 flex flex-col rounded-t shadow-2xl"
                        style={{ maxHeight: '85vh', height: '55vh' }}
                    >
                        {/* Drag Handle */}
                        ...
                        <div className="px-4 py-3 border-b border-gray-100 shrink-0">
                            <div className="flex justify-between items-center">
                                ...
                                <button
                                    onClick={() => setOpen(false)}
                                    className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100 transition-colors text-xl text-gray-500"
                                >×</button>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            style={{ overscrollBehavior: 'contain', scrollbarWidth: 'thin', scrollbarColor: '#CBD5E0 #F7FAFC' }}
                        >
                            <SummaryContent promoRef={promoInputRefMobile} />
                        </div>
                    </div>
                </>
            )}
