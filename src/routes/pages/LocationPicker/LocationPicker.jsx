...
export default function LocationPicker() {
    ...
    }, [map, setMapLatitude, setMapLongitude, setAddressLocation]);
                        ...
                        saveAddress.length > 0 && !showMapForNew ?
                            ...
                            <div className="">
                                ...
                                <div className="absolute top-80 right-3 z-20 flex flex-col space-y-2">
                                    ...
                                    <button  disabled={isGettingCurrentAddress} onClick={gotoMyLocation} className="bg-white shadow p-2 rounded-lg flex items-center justify-center">
                                        <FaLocationCrosshairs />
                                    </button>
